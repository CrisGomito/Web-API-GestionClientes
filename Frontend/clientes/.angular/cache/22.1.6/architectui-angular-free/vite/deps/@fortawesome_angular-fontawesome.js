import { $n as Output, Bt as computed, Fn as Injectable, Hl as _objectSpread2$1, In as Input, Ol as ɵɵdefineInjectable, Oo as ɵɵgetInheritedFactory, Ul as _defineProperty$1, Wi as setClassMetadata, X as input, an as ChangeDetectionStrategy, as as ɵɵprojectionDef, ba as ɵɵclassMap, ca as ɵɵInheritDefinitionFeature, cn as Component, gc as DOCUMENT$1, is as ɵɵprojection, kl as ɵɵdefineInjector, ks as ɵɵsanitizeHtml, ll as inject, mc as CSP_NONCE, mo as ɵɵdomProperty, no as ɵɵdefineDirective, nt as model, qn as NgModule, rl as effect, ro as ɵɵdefineNgModule, to as ɵɵdefineComponent, wn as Directive, ya as ɵɵattribute } from "./core-CpxyNpZz.js";
...
var _FaConfig;
var _FaIconLibrary;
var _FaStackItemSizeDirective;
var _FaStackComponent;
var _FaIconComponent;
var _FaDuotoneIconComponent;
var _FaLayersComponent;
var _FaLayersCounterComponent;
var _FaLayersTextComponent;
var _FontAwesomeModule;
var _c0 = ["*"];
var FaConfig = class {
	constructor() {
		_defineProperty$1(
		...
		_defineProperty$1(this, "_autoAddCss", true);
	}
	/**
...
_FaConfig = FaConfig;
_defineProperty$1(FaConfig, "ɵfac", function FaConfig_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _FaConfig)();
});
_defineProperty$1(FaConfig, "ɵprov", /* @__PURE__ */ ɵɵdefineInjectable({
	token: _FaConfig,
...
var FaIconLibrary = class {
	constructor() {
		_defineProperty$1(this, "definitions", {});
	}
	addIcons(...icons) {
...
_defineProperty$1(FaIconLibrary, "ɵfac", function FaIconLibrary_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _FaIconLibrary)();
});
_defineProperty$1(FaIconLibrary, "ɵprov", /* @__PURE__ */ ɵɵdefineInjectable({
...
var FaStackItemSizeDirective = class {
	constructor() {
		_defineProperty$1(
			...
			*/
			"stackItemSize",
			input("1x", ...ngDevMode ? [{ debugName: "stackItemSize" }] : 			/* istanbul ignore next */ [])
		);
		_defineProperty$1(
			this,
			/**
		...
		_defineProperty$1(this, "_effect", effect(() => {
...
_FaStackItemSizeDirective = FaStackItemSizeDirective;
_defineProperty$1(FaStackItemSizeDirective, "ɵfac", function FaStackItemSizeDirective_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _FaStackItemSizeDirective)();
});
_defineProperty$1(FaStackItemSizeDirective, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
var FaStackComponent = class {
	constructor() {
		...
		_defineProperty$1(this, "classes", computed(() => {
			const sizeValue = this.size();
			return _objectSpread2$1(_objectSpread2$1({}, sizeValue ? { [`fa-${sizeValue}`]: true } : {}), {}, { "fa-stack": true });
		}, ...ngDevMode ? [{ debugName: "classes" }] : 		/* istanbul ignore next */ []));
	}
};
_FaStackComponent = FaStackComponent;
_defineProperty$1(FaStackComponent, "ɵfac", function FaStackComponent_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _FaStackComponent)();
});
_defineProperty$1(FaStackComponent, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var FaIconComponent = class {
	constructor() {
		_defineProperty$1(this, "icon", model(...ngDevMode ? [void 0, { debugName: "icon" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(
			this,
			/**
			...
			*/
			"title",
			model(...ngDevMode ? [void 0, { debugName: "title" }] : 			/* istanbul ignore next */ [])
		);
		_defineProperty$1(
			this,
			/**
			...
			*/
			"animation",
			model(...ngDevMode ? [void 0, { debugName: "animation" }] : 			/* istanbul ignore next */ [])
		);
		_defineProperty$1(this, "mask", model(...ngDevMode ? [void 0, { debugName: "mask" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "flip", model(...ngDevMode ? [void 0, { debugName: "flip" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "size", model(...ngDevMode ? [void 0, { debugName: "size" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "pull", model(...ngDevMode ? [void 0, { debugName: "pull" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "border", model(...ngDevMode ? [void 0, { debugName: "border" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "inverse", model(...ngDevMode ? [void 0, { debugName: "inverse" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "symbol", model(...ngDevMode ? [void 0, { debugName: "symbol" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "rotate", model(...ngDevMode ? [void 0, { debugName: "rotate" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "fixedWidth", model(...ngDevMode ? [void 0, { debugName: "fixedWidth" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "transform", model(...ngDevMode ? [void 0, { debugName: "transform" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(
			this,
			/**
			...
			*/
			"a11yRole",
			model(...ngDevMode ? [void 0, { debugName: "a11yRole" }] : 			/* istanbul ignore next */ [])
		);
		_defineProperty$1(this, "renderedIconHTML", computed(() => {
			var _this$icon;
			const iconValue = (_this$icon = this.icon()) !== null && _this$icon !== void 0 ? _this$icon : this.config.fallbackIcon;
			if (!iconValue) {
		...
		_defineProperty$1(this, "cspNonce", inject(CSP_NONCE));
		_defineProperty$1(this, "document", inject(DOCUMENT$1));
		_defineProperty$1(this, "sanitizer", inject(DomSanitizer));
		_defineProperty$1(this, "config", inject(FaConfig));
		_defineProperty$1(this, "iconLibrary", inject(FaIconLibrary));
		_defineProperty$1(this, "stackItem", inject(FaStackItemSizeDirective, { optional: true }));
		_defineProperty$1(this, "stack", inject(FaStackComponent, { optional: true }));
	...
	buildParams() {
		...
		return {
			...
			mask: maskIconDefinition !== null && maskIconDefinition !== void 0 ? maskIconDefinition : void 0,
			symbol: this.symbol(),
			attributes,
			styles
		};
...
_FaIconComponent = FaIconComponent;
_defineProperty$1(FaIconComponent, "ɵfac", function FaIconComponent_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _FaIconComponent)();
});
_defineProperty$1(FaIconComponent, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	...
	hostBindings: function FaIconComponent_HostBindings(rf, ctx) {
		if (rf & 2) {
			...
			ɵɵattribute("title", (_ctx$title = ctx.title()) !== null && _ctx$title !== void 0 ? _ctx$title : void 0);
		}
	},
	inputs: {
		icon: [1, "icon"],
...
var FaDuotoneIconComponent = class extends FaIconComponent {
	constructor(..._args) {
		...
		_defineProperty$1(
			...
			*/
			"swapOpacity",
			input(...ngDevMode ? [void 0, { debugName: "swapOpacity" }] : 			/* istanbul ignore next */ [])
		);
		_defineProperty$1(
			this,
			/**
			...
			*/
			"primaryOpacity",
			input(...ngDevMode ? [void 0, { debugName: "primaryOpacity" }] : 			/* istanbul ignore next */ [])
		);
		_defineProperty$1(
			this,
			/**
			...
			*/
			"secondaryOpacity",
			input(...ngDevMode ? [void 0, { debugName: "secondaryOpacity" }] : 			/* istanbul ignore next */ [])
		);
		_defineProperty$1(
			this,
			/**
			...
			*/
			"primaryColor",
			input(...ngDevMode ? [void 0, { debugName: "primaryColor" }] : 			/* istanbul ignore next */ [])
		);
		_defineProperty$1(
			this,
			/**
			...
			*/
			"secondaryColor",
			input(...ngDevMode ? [void 0, { debugName: "secondaryColor" }] : 			/* istanbul ignore next */ [])
		);
	}
	findIconDefinition(i) {
...
_FaDuotoneIconComponent = FaDuotoneIconComponent;
_defineProperty$1(FaDuotoneIconComponent, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty$1(FaDuotoneIconComponent, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var FaLayersComponent = class {
	constructor() {
		_defineProperty$1(this, "size", input(...ngDevMode ? [void 0, { debugName: "size" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "fixedWidth", input(...ngDevMode ? [void 0, { debugName: "fixedWidth" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "faFw", computed(() => {
			const fixedWidth = this.fixedWidth();
			return typeof fixedWidth === "boolean" ? fixedWidth : this.config.fixedWidth;
		}, ...ngDevMode ? [{ debugName: "faFw" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "classes", computed(() => {
			const sizeValue = this.size();
			return _objectSpread2$1(_objectSpread2$1({}, sizeValue ? { [`fa-${sizeValue}`]: true } : {}), {}, {
				"fa-fw": this.faFw(),
				"fa-layers": true
			});
		}, ...ngDevMode ? [{ debugName: "classes" }] : 		/* istanbul ignore next */ []));
...
_FaLayersComponent = FaLayersComponent;
_defineProperty$1(FaLayersComponent, "ɵfac", function FaLayersComponent_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _FaLayersComponent)();
});
_defineProperty$1(FaLayersComponent, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var FaLayersCounterComponent = class {
	constructor() {
		_defineProperty$1(this, "content", input.required(...ngDevMode ? [{ debugName: "content" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "title", input(...ngDevMode ? [void 0, { debugName: "title" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "position", input(...ngDevMode ? [void 0, { debugName: "position" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "renderedHTML", computed(() => {
			const params = this.buildParams();
		...
		_defineProperty$1(this, "document", inject(DOCUMENT$1));
		_defineProperty$1(this, "config", inject(FaConfig));
		_defineProperty$1(this, "parent", inject(FaLayersComponent, { optional: true }));
		_defineProperty$1(this, "sanitizer", inject(DomSanitizer));
...
_FaLayersCounterComponent = FaLayersCounterComponent;
_defineProperty$1(FaLayersCounterComponent, "ɵfac", function FaLayersCounterComponent_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _FaLayersCounterComponent)();
});
_defineProperty$1(FaLayersCounterComponent, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var FaLayersTextComponent = class {
	constructor() {
		_defineProperty$1(this, "content", input.required(...ngDevMode ? [{ debugName: "content" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "title", input(...ngDevMode ? [void 0, { debugName: "title" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "flip", input(...ngDevMode ? [void 0, { debugName: "flip" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "size", input(...ngDevMode ? [void 0, { debugName: "size" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "pull", input(...ngDevMode ? [void 0, { debugName: "pull" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "border", input(...ngDevMode ? [void 0, { debugName: "border" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "inverse", input(...ngDevMode ? [void 0, { debugName: "inverse" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "rotate", input(...ngDevMode ? [void 0, { debugName: "rotate" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "fixedWidth", input(...ngDevMode ? [void 0, { debugName: "fixedWidth" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "transform", input(...ngDevMode ? [void 0, { debugName: "transform" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "renderedHTML", computed(() => {
			const params = this.buildParams();
			return this.updateContent(params);
		}, ...ngDevMode ? [{ debugName: "renderedHTML" }] : 		/* istanbul ignore next */ []));
...
_FaLayersTextComponent = FaLayersTextComponent;
_defineProperty$1(FaLayersTextComponent, "ɵfac", function FaLayersTextComponent_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _FaLayersTextComponent)();
});
_defineProperty$1(FaLayersTextComponent, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
_FontAwesomeModule = FontAwesomeModule;
_defineProperty$1(FontAwesomeModule, "ɵfac", function FontAwesomeModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _FontAwesomeModule)();
});
_defineProperty$1(FontAwesomeModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
...
_defineProperty$1(FontAwesomeModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({}));
(() => {
